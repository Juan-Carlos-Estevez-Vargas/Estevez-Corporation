...
public class Constants {
    ...
    public static final String ERROR_GENERATING_USER_LIST = "Error al generar lista de usuarios";
    public static final String ERROR_GET_USER_LIST = "Error al obtener el listado usuarios";
    public static final String ERROR_GET_CLIENT_LIST = "Error al obtener el listado de clientes";
    ...
    public static final String SUCCESSFUL_MODIFICATION = "Modificación exitosa!!";

    // VALIDATE FIELDS
    public static final String CANNOT_UPDATE_SUPER_ADMIN = "No es posible actualizar el super administrador";
