...
public class AdministratorPanelView extends JFrame implements ActionListener {
    ...
    private void initComponents() {
        ...
        panelBack.setBackground(Constants.BACKGROUND_COLOR);
    ...
    private void handleRegisterUser() {
        RegisterUserView registerUser = new RegisterUserView();
