...
public class RegisterClient extends JFrame implements ActionListener {
	...
	public RegisterClient() {
		...
		this.setTitle("Registrar nuevo cliente - Sesi�n de " + this.user);
	...
	public void initComponents() {
		 ...
		 */
		this.labelPhoneClient = new JLabel("Tel�fono:");
		...
		/**
		 * Campo de texto para ingresar el tel�fono del Cliente a registrar.
		 */
		...
		/**
		 * Label Direcci�n Cliente.
		 */
		this.labelAdressClient = new JLabel("Direcci�n:");
		...
		/**
		 * Campo de texto para ingresar la direcci�n del cliente a registrar.
		 */
		...
		/**
		 * Bot�n para registrar un Cliente en el sistema.
		 */
		...
		if (e.getSource() == this.btnRegisterClient) {
			...
			if (mail.equals("") || mail.length() >= 40 || !(mail.contains("@") && mail.contains("."))) {
				...
				if (!(mail.contains("@") && mail.contains("."))) {
					JOptionPane.showMessageDialog(null, "El campo EMAIL no es v�lido");
					this.txtEmailClient.requestFocus();
				}
				validation++;
			}
			if (phone.equals("") || phone.length() >= 12) {
				...
				if (phone.length() >= 12 || phone.length() < 10) {
					JOptionPane.showMessageDialog(null,
							"El campo TEL�FONO no debe contener m�s de 12 caracteres ni menos de 10");
			...
			if (adress.equals("") || adress.length() >= 60) {
				...
				if (adress.length() >= 60) {
					JOptionPane.showMessageDialog(null, "El campo DIRECCI�N no debe contener m�s de 60 caracteres");
