...
/**
 * Frame encargado de registrar un equipo asociado a un cliente espec�fico.
 *
...
public class RegisterEquipment extends JFrame implements ActionListener {
	...
	public RegisterEquipment() {
		...
		this.setTitle("Registrar nuevo Equipo - Sesi�n de " + this.user);
	...
	public void initComponents() {
		...
		/**
		 * Label N�mero Serial del Equipo.
		 */
		...
		/**
		 * Campo de texto para ingresar el n�mero serial del equipo a registrar.
		 */
		...
		/**
		 * Bot�n para ingresar el equipo en cuesti�n.
		 */
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == this.btnRegisterEquip) {
			...
			year = Integer.toString(calendar.get(Calendar.YEAR)); // Recuperamos el a�o de ingreso del equipo
