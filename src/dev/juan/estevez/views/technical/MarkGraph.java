...
/**
 * Gr�fica de torta con la cantidad de equipos registrados en el sistema.
 *
 * @author
 *
 */
public class MarkGraph extends JFrame {
    ...
    public MarkGraph() {
        ...
        this.setTitle("T�cnico - Sesi�n de " + user);
    ...
    public void paint(Graphics g) {
        ...
        g.drawString("Gr�fica de marcas registradas", 150, 68);
    }
}
